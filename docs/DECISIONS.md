...
## Decisions of 2026-08-31 (second verification session, defects V-01 – V-11)

Taken while fixing what the second independent verification found. Full findings in
`docs/AUDIT-2026-08-29.md` §15. No ADR accompanies these: each one implements an existing ADR that
the code was violating rather than reinterpreting.
