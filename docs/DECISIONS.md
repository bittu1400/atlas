...
| D100 | STATUS.md rewrite (T-31) | **Rewritten from measurement, in this session.** The previous body was carried forward from before the audit and every metric in it was false; the audit §12 block additionally recorded the tree as "committed and clean" when nothing had been committed (**R7**, finding A1). The old body is retained below the rewrite as evidence (**R11**). | — |
